...
var author$project$Main$viewSelect = function (model) {
	return model.usernameSelected ? author$project$Main$chatView(model) : author$project$Main$enterNameView(model);
};
